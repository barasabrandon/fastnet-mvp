...
const initialPricingData: PricingData = {
  ...
  weekly: [
    ...
    { id: 12, name: '3-Day Pass', price: 68, duration: '3 days', devices: 1, speed: '5Mbps' },
    { id: 13, name: '2-Day Duo', price: 78, duration: '3 days', devices: 2, speed: '5Mbps' },
    { id: 14, name: '3-Day Duo', price: 110, duration: '3 days', devices: 2, speed: '5Mbps' },
    { id: 15, name: 'Weekly Pass', price: 158, duration: '7 days', devices: 1, speed: '5Mbps' },
    { id: 16, name: 'Weekly Duo', price: 255, duration: '7 days', devices: 2, speed: '5Mbps' },
    { id: 17, name: 'Weekly Streaming', price: 268, duration: '7 days', devices: 1, speed: '8Mbps' },
  ],
  monthly: [
    ...
    { id: 20, name: '3 Weeks Unlimited', price: 421, duration: '21 days', devices: 1, speed: '5Mbps' },
    ...
    { id: 27, name: 'Monthly 3 Devices', price: 1198, duration: '30 days', devices: 3, speed: '5Mbps' },
  ],
  data: [
